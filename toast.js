/**
 * Toast notification system for KelasGuru
 * A reusable toast notification system with Shadcn UI styling
 */
...
function showToast(type, message, duration = 5000) {
    ...
    switch (type) {
        case 'success':
            iconSvg = `<svg class="toast-icon" width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    toast.innerHTML = `
        ...
        <button class="toast-close" aria-label="Close notification" onclick="closeToast('${toastId}')">
